...
# set your api key
os.environ["GOOGLE_API_KEY"] = "AIzaSyD3H7u-8tl-6D_c6Zw6Z61adr_na-N4UkU"
...
def recommendation():
    if request.method == 'POST':
        ...
        #split and map response based on keywords
        ...
        for line in recommendations_text.splitlines():
            if "Diet Recommendations:" in line:
                ...
                recommendation[current_section].append(line.strip())
